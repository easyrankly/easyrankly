(function () {
  ...
  /**
   * Reusable "expandable table panel" behavior shared by the Redirects,
   * Broken-Link Candidates, and Frequent 404 sections. Data-attribute driven:
   *
   *   [data-erankly-expandable]        the section that widens (needs an id)
   *   [data-erankly-expand-toggle]     the expand/collapse button inside it
   *   [data-erankly-filter]            optional live filter input
   *   [data-erankly-filter-row]        rows the filter shows/hides
   *   data-filter-text                 lowercased haystack on each row
   */
